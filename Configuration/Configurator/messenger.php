...
return static function (ContainerConfigurator $container) {
    $container->services()
        ...
        ->args([abstract_arg('failure transports'), service('logger') ->ignoreOnInvalid()])
        ->tag('kernel.event_subscriber')
        ->tag('monolog.logger', [
            'channel' => 'messenger',
        ])
        ...
        ->args([service('cache.messenger.restart_workers_signal'), service('logger') ->ignoreOnInvalid()])
        ->tag('kernel.event_subscriber')
        ->tag('monolog.logger', [
            'channel' => 'messenger',
        ])
